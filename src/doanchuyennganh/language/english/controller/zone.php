...
$_['heading_form_title']	= 'Zone:';
$_['heading_description']	= 'You can edit your zones here.<br>To limit list to only zones for one country, search by that country';
...
$_['error_vendor']		= 'Warning: This Zone cannot be deleted as it is currently assigned to 1 vendor!';
$_['error_vendors']		= 'Warning: This Zone cannot be deleted as it is currently assigned to %s vendors!';
