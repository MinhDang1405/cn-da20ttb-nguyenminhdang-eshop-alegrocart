    ...
    <div class="pages">
      <div class="page">
        <div class="pad">
          <table>
            ...
            <tr>
              ...
              <td><select name="catalog_category_mcount">
                  <?php if ($catalog_category_mcount) { ?>
                  <option value="1" selected><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
                  <option value="1"><?php echo $text_enabled; ?></option>
		...
		<td class="expl">
            ...
            <tr>
              <td width="185" class="set"><?php echo $entry_product_count_page; ?></td>
              <td><select name="catalog_category_pcount">
                  <?php if ($catalog_category_pcount) { ?>
                  <option value="1" selected><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
                  <option value="1"><?php echo $text_enabled; ?></option>
		...
		<tr>
              ...
              <td><select name="catalog_category_ratings">
                  <?php if ($catalog_category_ratings) { ?>
                  <option value="1" selected><?php echo $text_enabled; ?></option>
                  <option value="0"><?php echo $text_disabled; ?></option>
                  <?php } else { ?>
                  <option value="1"><?php echo $text_enabled; ?></option>
