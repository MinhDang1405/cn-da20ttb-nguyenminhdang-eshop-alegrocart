    ...
    <div class="pages">
      <div class="page">
        <div class="pad">
          <table>
            <tr>
              ...
              <td><select name="global_warehouse_status">
                  <?php if ($global_warehouse_status) { ?>
	      ...
	      <td class="expl"><?php echo $explanation_entry_status; ?></td>
            ...
            <tr>
              ...
              <td><select name="global_warehouse_geo_zone_id">
                  <option value="0"><?php echo $text_all_zones; ?></option>
                  <?php foreach ($geo_zones as $geo_zone) { ?>
                  <?php if ($geo_zone['geo_zone_id'] == $global_warehouse_geo_zone_id) { ?>
	      ...
	      <td class="expl"><?php echo $explanation_entry_geo_zone; ?></td>
            ...
            <tr>
	      <td valign="top" class="set"><?php echo $entry_location; ?></td>   
	      <td><textarea name="global_warehouse_location" cols="40" rows="5"><?php echo $global_warehouse_location; ?></textarea>
	      <td valign="top" class="expl"><?php echo $explanation_entry_location; ?></td>
            </tr>
            <tr>
              <td class="set"><?php echo $entry_handling_fee; ?></td>
              <td><input class="validate_float" id="warehouse_handling_fee" type="text" name="global_warehouse_handling_fee" value="<?php echo $global_warehouse_handling_fee; ?>"></td>
	      <td class="expl"><?php echo $explanation_entry_handling_fee; ?></td>
            </tr>
	    <tr>
              <td class="set"><?php echo $entry_tax; ?></td>
              <td><select name="global_warehouse_tax_class_id">
                  <option value="0"><?php echo $text_none; ?></option>
                  <?php foreach ($tax_classes as $tax_class) { ?>
                  <?php if ($tax_class['tax_class_id'] == $global_warehouse_tax_class_id) { ?>
	    ...
	    <tr>
              ...
              <td><input class="validate_int" id="warehouse_sort_order" type="text" name="global_warehouse_sort_order" value="<?php echo $global_warehouse_sort_order; ?>" size="1"></td>
