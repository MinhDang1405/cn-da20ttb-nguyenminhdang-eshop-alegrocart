      ...
      <div class="page">
		...
		<td class="expl">
			...
			<tr>
			  ...
			  <td><input class="validate_int" id="recently_image_height" type="text" name="catalog_recently_image_height" value="<?php echo $catalog_recently_image_height; ?>" size="3"></td>
		<td class="expl">
			...
			<tr>
			  ...
			  <td><input class="validate_int" id="recently_image_width" type="text" name="catalog_recently_image_width" value="<?php echo $catalog_recently_image_width; ?>" size="3"></td>
		<td class="expl">
		...
		<td class="expl">
			...
			<tr>
              ...
              <td><input class="validate_int" id="recently_lines_single" type="text" name="catalog_recently_lines_single" value="<?php echo $catalog_recently_lines_single; ?>" size="1" /></td>
		<td class="expl">
			...
			<tr>
              ...
              <td><input class="validate_int" id="recently_lines_multi" type="text" name="catalog_recently_lines_multi" value="<?php echo $catalog_recently_lines_multi; ?>" size="1" /></td>
		<td class="expl">
			...
			<tr>
              ...
              <td><input class="validate_int" id="recently_lines_char" type="text" name="catalog_recently_lines_char" value="<?php echo $catalog_recently_lines_char; ?>" size="3" /></td>
		<td class="expl">
			<?php echo($explanation_entry_char); ?>
		</td>
            </tr>
            <tr>
              <td style="color:#0099FF; font-weight:bold"><?php if ($catalog_recently_slider) { ?>
                <input type="radio" name="catalog_recently_slider" value="1" id="cfsyes" checked="checked">
                <label for="cfsyes"><?php echo $entry_sliderb; ?></label>
                <?php } else { ?>
                <input type="radio" name="catalog_recently_slider" value="1" id="cfsyes" >
                <label for="cfsyes"><?php echo $entry_sliderb; ?></label>
                <?php } ?></td>
            </tr>
            <tr>
              <td class="set"><?php echo $entry_columns; ?></td>
              <td><select name="catalog_recently_scolumns">
				<?php foreach($scolumn_data as $scolumn){?>
				  <?php if($scolumn == $catalog_recently_scolumns){?>
		...
		<td class="expl">
            ...
            <tr>
              ...
              <td><input class="validate_int" id="recently_slimit" type="text" name="catalog_recently_slimit" value="<?php echo $catalog_recently_slimit; ?>" size="1" /></td>
		<td class="expl">
            ...
            <tr>
              <td style="color:#0099FF; font-weight:bold"><?php if ($catalog_recently_slider) { ?>
                <input type="radio" name="catalog_recently_slider" value="0" id="cfsno" >
                <label for="cfsno"><?php echo $entry_columnb; ?></label>
                <?php } else { ?>
                <input type="radio" name="catalog_recently_slider" value="0" id="cfsno" checked="checked">
                <label for="cfsno"><?php echo $entry_columnb; ?></label>
                <?php } ?></td>
            </tr>
            <tr>
		...
		<td class="expl">
            ...
            <tr>
              <td class="set"><?php echo $entry_limit; ?></td>
              <td><input class="validate_int" id="recently_limit" type="text" name="catalog_recently_limit" value="<?php echo $catalog_recently_limit; ?>" size="1" /></td>
		<td class="expl">
