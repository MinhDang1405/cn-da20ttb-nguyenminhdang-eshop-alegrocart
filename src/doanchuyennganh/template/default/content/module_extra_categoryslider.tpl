    ...
    <div class="pages">
      <div class="page">
        <div class="pad">
          <table>
            <tr>
              ...
              <td><select name="catalog_categoryslider_status">
                  <?php if ($catalog_categoryslider_status) { ?>
		...
		<tr>
		  ...
		  <td><input class="validate_int" id="categoryslider_image_height" type="text" name="catalog_categoryslider_image_height" value="<?php echo $catalog_categoryslider_image_height; ?>" size="3"></td>
		  <td class="expl"><?php echo $text_image;?></td>
		</tr>
		<tr>
		  <td class="set"><?php echo $entry_width; ?></td>
		  <td><input class="validate_int" id="categoryslider_image_width" type="text" name="catalog_categoryslider_image_width" value="<?php echo $catalog_categoryslider_image_width; ?>" size="3"></td>
		</tr>
          </table>
        </div>
      </div>
