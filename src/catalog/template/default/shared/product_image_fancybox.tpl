<script type="text/javascript">$(document).ready(function(){$("a#<?php echo $this_controller.'_enlarge'.$product['product_id']; ?>").fancybox({'titleShow'  : false, 'transitionIn' : 'elastic',  'transitionOut' : 'elastic'}); });</script>
...
<div class="enlarge"> <a id="<?php echo $this_controller.'_enlarge'.$product['product_id']; ?>" href="<?php echo $product['popup']; ?>"> <?php echo $text_enlarge; ?></a></div>
