<div class="headingpadded"><h2><?php echo $heading_title . $heading_info; ?></h2></div>
 <div class="module">
  <?php 
   ...
   ?>
  <div class="<?php echo $this_controller; ?><?php echo isset($id) && $id ? '_'.$id :''; ?>_row" style="min-height: <?php echo $min_height; ?>px;">
...
$(document).ready(function(){
  $('.<?php echo $this_controller; ?><?php echo isset($id) && $id ? "_".$id :""; ?>_row').slick({
		dots: false,
		autoplay: false,
		infinite: false,
		slidesToScroll: 1,
