<?php  // Manufacturer List AlegroCart
class ModuleManufacturerList extends Controller {
		var $remaining = false;
			...
			foreach ($manufacturers as $manufacturer){
				...
				foreach ($results as $result) {
					...
					$product_data[] = array(
						...
						'href'			=> $url->href('product', FALSE, array('manufacturer_id' => $manufacturer['manufacturer_id'], 'product_id' => $result['product_id'])),
